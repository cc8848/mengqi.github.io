define(function(require,exports){
    ...
    function getStyle(oPlanet){
        ...
        var str = "在网上看到的几个使用动画特效做成的案例，感觉很棒，闲来无事就动手在案例设计基础上加上自己的设计想法用原生js做成此小站。小站是使用seajs进行的一站式开发，其中技术多以html5和css3、javascript为主，其中有的部分细节还没有处理的很好，小站会不断进行改进，另外说一下，由于大量的HTML5和css3所以你懂的，只做了谷歌和火狐的兼容。"
